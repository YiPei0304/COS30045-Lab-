function init() {
    var w = 600;
        ...
        var barPadding = 3;
        var maxValue = 25;
        var ascending = true; // Track the current sort order
        ...
        // Sort function (ascending and descending toggle)
        function sortBars() {
            svg1.selectAll("rect")
                .sort(function(a, b) {
                    if (ascending) {
            ...
            ascending = !ascending;  // Toggle the sort order for the next click
        }
        ...
        d3.select("#sort").on("click", function() {
            sortBars();  // Call the sorting function
        });
